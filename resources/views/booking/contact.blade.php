			...
			<header class="header" id="header">
				<nav class="nav container">
					...
					<div class="nav__menu">
						<ul class="nav__list">
							<li class="nav__item">
								<a href="index.blade.php" class="nav__link">
							...
							<li class="nav__item">
								<a href="contact.blade.php" class="nav__link active-link flick">
        ...
        <main class="main">
            ...
            <section>
              <div class="container flow-content">
                <h2 class="section-title flick">Our team</h2>
                    ...
                    <article class="card" data-visible="false">
                      ...
                      <div class="card__back flow-content">
                        ...
                        <ul role="list" class="card__social flex-group">
                          ...
                          <li>
                            <a href="https://www.linkedin.com/in/mark-renier-mercado-2a6466268">
                    ...
                    <article class="card" data-visible="false">
                      ...
                      <div class="card__back flow-content">
                        ...
                        <ul role="list" class="card__social flex-group">
                          ...
                          <li>
                            <a href="https://www.linkedin.com/in/shaun-dequilla-0a31491a4/">
                              <i class="fa-brands fa-linkedin "></i>
                            </a>
                          </li>
                        </ul>
...
<footer class="footer section">
  ...
  <script src="/VNV-RESORT-BOOKING/resources/js/main.js"></script>
   <!--=============== CONTACT JS ===============-->
  <script src="/VNV-RESORT-BOOKING/resources/js/contact.js"></script>
